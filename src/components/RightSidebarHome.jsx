...
const RightSidebarHome = () => {
  return (
    <div className="col-md-3 bg-white p-3 border-start" style={{ minHeight: '100vh' }}>
      <h6 className="fw-bold mb-3">In primo piano</h6>
      <ul className="list-unstyled">
        <li className="mb-2">
          <strong>Big Ideas 2025</strong><br />
          <small className="text-muted">11 giorni fa · 4.302 lettori</small>
        </li>
        <li className="mb-2">
          <strong>Tech 2025</strong><br />
        ...
        <li className="mb-2">
          <strong>Maximall Pompei</strong><br />
      ...
      <div className="border-top pt-3 mt-3">
        ...
        <ul className="list-unstyled">
          <li><a href="#tango" className="text-decoration-none">🟨 Tango - Armonizza la griglia</a></li>
          <li><a href="#queens" className="text-decoration-none">🟪 Queens - Incorona ogni regione</a></li>
        </ul>
      </div>
    </div>
  );
