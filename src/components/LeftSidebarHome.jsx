import '../assets/css/LeftSidebarHome.css'
...
const LeftSidebarHome = () => {
  return (
    <div className="bg-white p-3 border-end mt-4">
      ...
      <div className="mb-3">
        <p className="mb-1">
          <strong>Visitatori del profilo:</strong>{' '}
          <span className="text-primary">2</span>
        </p>
        <p className="mb-1">
          <strong>Impressioni del post:</strong>{' '}
      ...
      <div className="border-top pt-3">
        ...
        <ul className="list-unstyled">
          <li>
            <a href="#gruppi" className="text-decoration-none">
              Gruppi
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#eventi" className="text-decoration-none">
              Eventi
            </a>
          </li>
        </ul>
